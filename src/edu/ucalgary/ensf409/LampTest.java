 ...
 public class LampTest {
     ...
     public void constructorLampTest() {
         Lamp testLamp = new Lamp("study", "lamp", 1, "jdbc:mysql://localhost/inventory", "scm", "ensf409");
         String[] expected = { "study", "lamp", String.valueOf(1), "jdbc:mysql://localhost/inventory", "scm",
                 "ensf409" };
     ...
     public void initializeConnectionTest() {
         Lamp testLamp1 = new Lamp("study", "lamp", 1, "jdbc:mysql://localhost/inventory", "scm", "ensf409");
     ...
     public void getEverythingTest() {
         Lamp testLamp2 = new Lamp("study", "lamp", 1, "jdbc:mysql://localhost/inventory", "scm", "ensf409");
     ...
     public void getManufacturersTest() {
         Chair testChair2 = new Chair("study", "lamp", 1, "jdbc:mysql://localhost/inventory", "scm", "ensf409");
         ...
         try {
             ...
             rs = stmnt.executeQuery("SELECT * FROM LAMP WHERE Type = " + "'" + testChair2.getCategory() + "'");
             int i = 0;
             while (rs.next()) {
     ...
     public void sortLowestPriceTest() {
         Lamp testLamp3 = new Lamp("study", "lamp", 1, "jdbc:mysql://localhost/inventory", "scm", "ensf409");
     ...
     public void numberOfPartsTest() {
         Lamp testLamp4 = new Lamp("swing arm", "lamp", 3, "jdbc:mysql://localhost/inventory", "scm", "ensf409");
         int[] expected = { 3 };
     ...
     public void suggestedManufacturerTest() {
         Lamp testLamp7 = new Lamp("desk", "lamp", 3, "jdbc:mysql://localhost/inventory", "scm", "ensf409");
     ...
     public void removePartsTest() {
         Lamp testLamp8 = new Lamp("study", "lamp", 2, "jdbc:mysql://localhost/inventory", "scm", "ensf409");
     ...
     public void writeFileLampOrderTest() throws IOException {
         ...
         int priceTotal = 150;
         Lamp testLamp9 = new Lamp("study", "lamp", 1, "jdbc:mysql://localhost/inventory", "scm", "ensf409");
     ...
     public void writeFileSuggestedManuTest() throws IOException {
         Lamp testLamp10 = new Lamp("study", "lamp", 7, "jdbc:mysql://localhost/inventory", "scm", "ensf409");
