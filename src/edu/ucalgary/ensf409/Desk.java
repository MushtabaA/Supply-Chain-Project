...
public class Desk {
    ...
    /**
     * The type which includes standing, traditional and adjustable
     */
    private String type;
   ...
   */
    ...
    public void getManufacturers(String category) {
        ...
        try {
            ...
            stmnt = createConnection.createStatement();
            //Uses the result set to gather data about the desk which is for the specfic
     ...
     * for example a standing desk. Then it will just add 0s in the array list. 
     ...
     * combination which was found from the select desk table. 
     */
    public void findingCombinations() {
        ...
        //The amount of each furniture piece to make one desk 
        int numOfLegs = 0;
        int numOfTops = 0;
        int numOfDrawers = 0;
        int numOfCushions = 0;
        ...
        for (int a = 0; a < possibleCombinations.size(); a++) {
            ...
            for (int i = 0; i < partIDs.size(); i++) {
                ...
                try {
                    ...
                    while(rs2.next()) {
                         //Checks for the desks legs and what their status 
                        //Is in the database 
                        if (rs2.getString("Legs").equals("Y")) {
                            numOfLegs++;
                        }
                         //Checks for the desks top and what their status 
                        //Is in the database 
                        if (rs2.getString("Top").equals("Y")) {
                            numOfTops++;
                        }
                         //Checks for the desks drawer and what their status 
                        //Is in the database 
    ...
    public void removeParts() {
        ...
        try {
            ...
            for (int i = 0; i < removedParts.size(); i++) {
                ...
                stmnt.executeUpdate("DELETE FROM DESK WHERE ID = "+ "'" + removedParts.get(i) + "'");
                stmnt.close();
            }
        }
